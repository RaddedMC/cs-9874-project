...
FEDERATED_ARTIFACTS_DIR = SCRIPT_DIR.parent / "artifacts" / "local_dp" / "tests"
INPUT_CSV = FEDERATED_ARTIFACTS_DIR / "test_ldp_metrics.csv"
...
def save_metric_plot(df: pd.DataFrame, metric: str) -> Path:
	...
	output_path = FEDERATED_ARTIFACTS_DIR / f"test_ldp_{metric}.png"
